...
const experienceItems = [
  {
    ...
    org: "皆可文化创意有限公司",
    desc: [
      "统筹 AIGC 漫剧全流程制作管理，带领团队完成内容策划、AI 生成、后期打磨全环节，搭建标准化产出 SOP。",
      "以导演视角把控内容叙事节奏与视觉风格，统一成品质量标准，确保内容适配短视频平台受众偏好。",
      "制定项目排期并协调组内分工，保障多项目并行推进，在职期间高效交付多部漫剧成品。",
    ],
  },
  {
    ...
    org: "数智文化传媒有限公司",
    desc: [
      "牵头搭建公司 AI 内容业务线，负责 AI 漫剧、AI 商业广告两大品类从 0 到 1 落地。",
      "覆盖商务拓展、客户对接、需求转化、项目管控全链路，统筹制作与运营多岗位协同。",
      "主导产出 10 余部 AIGC 漫剧、2 支商业广告片，操盘万粉级抖音漫剧账号，打通内容创作到流量变现路径。",
    ],
  },
  {
    ...
    desc: [
      "代表己方公司派驻联合项目，全面负责 AI 漫剧与 AI 广告内容线的整体规划与落地执行。",
      "对接双方资源，统筹商务需求与制作团队，制定项目排期与品控标准，保障合作项目按期高质量交付。",
      "拓展 AIGC 内容商业化场景，丰富内容品类与合作渠道，推进项目规模化产能落地。",
    ],
  },
];
...
const strengths = [
  ["全链路复合能力", "兼具项目负责人与内容导演双重身份，能打通商务拓展、客户沟通、团队管理、制作 SOP、内容创作与交付回款，适配轻量化团队高效作战。", Layers3],
  ["实战成果清晰可查", "主导制作 10 余部 AIGC 漫剧成片、2 支商业广告作品，操盘万粉级抖音漫剧账号，具备从 0 到 1 搭建内容产品线的能力。", BarChart3],
  ["专业创作基底扎实", "拥有系统的视听创作与审美积淀，在校期间斩获多项专业赛事奖项，能将专业创作标准与 AIGC 工具效率结合。", BadgeCheck],
];
    ...
    <section className="profile section" id="profile">
      <div className="shell profileGrid">
        <div className="profileIntro">
          ...
          <h2>个人优势</h2>
          <p>
            以 AIGC 视频导演为核心，兼具商业转化、团队统筹、内容制作与账号运营经验，能够把创意判断转化为稳定可交付的项目结果。
          </p>
